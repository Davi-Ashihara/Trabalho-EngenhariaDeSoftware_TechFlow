...
import br.com.fecaf.util.DAO.TaskDAO;
...
public class MainFrame extends javax.swing.JFrame {
    ...
    private void applyDesignTweaks() {
        ...
        // Adiciona um listener de DUPLO-CLIQUE na tabela para editar observações
        ...
        // Carrega os ícones para os botões (opcional)
        try {
            // ... (seu código de ícones)
        } catch (Exception ex) {
            System.err.println("Aviso: Ícones não encontrados.");
        }
    }
    
    // Método para lidar com o duplo-clique, para manter o código limpo
    private void handleDoubleClickOnTable() {
        ...
        // NOTA: Chamar getAllTasks() novamente é ineficiente. Uma melhoria futura seria ter um taskDAO.getTaskById(taskId).
        // Mas para este projeto, funciona perfeitamente.
    ...
    private void loadTasks() {
        ...
        for (Task task : tasks) {
            // --- CORREÇÃO 2: ADICIONAR OS 4 CAMPOS NA ORDEM CORRETA ---
            model.addRow(new Object[]{
                task.getId(), 
                task.getTitle(), 
                task.getStatus(), 
                task.getObservation() // <-- Estava a faltar este campo
            });
        }
    }
    ...
    /**
     * Classe interna para renderizar as cores da célula de Status.
     */
...
private void addPlaceholderStyle(javax.swing.JTextField textField, String placeholder) {
    ...
    private void initComponents() {
        ...
        btnDone.setText("Declarar Tarefa Feira");
        ...
        btnInProgress.setText("Declarar tarefa em progresso");
    ...
    private void btnAddTaskActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddTaskActionPerformed
        ...
        if (success) {
            // Se funcionou, mostramos uma mensagem de sucesso (opcional, mas bom para feedback)
            // JOptionPane.showMessageDialog(this, "Tarefa adicionada com sucesso!", "Sucesso", JOptionPane.INFORMATION_MESSAGE);
            txtNewTaskTitle.setText(""); // Limpa o campo de texto
            loadTasks(); // Recarrega a tabela para mostrar a nova tarefa
        } else {
            // Se falhou, informamos o utilizador de forma clara!
    ...
    private void btnDeleteTaskActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDeleteTaskActionPerformed
        ...
        if (confirmation == JOptionPane.YES_OPTION) {
            int taskId = (int) tblTasks.getValueAt(selectedRow, 0); // Pega o ID da primeira coluna
